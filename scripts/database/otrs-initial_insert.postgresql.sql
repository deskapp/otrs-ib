...
INSERT INTO notification_event_message (notification_id, content_type, language, subject, text)
    VALUES
    (14, 'text/plain', 'pl', 'Przypomnienie: <OTRS_APPOINTMENT_TITLE>', 'Witaj <OTRS_NOTIFICATION_RECIPIENT_UserFirstname>,

Upłynął czas przypomnienia o spotkaniu <OTRS_APPOINTMENT_TITLE>.

Opis: <OTRS_APPOINTMENT_DESCRIPTION>
Lokalizacja: <OTRS_APPOINTMENT_LOCATION>
Kalendarz: <OTRS_CALENDAR_CALENDARNAME>
Czas rozpoczęcia: <OTRS_APPOINTMENT_STARTTIME>
Czas zakończenia: <OTRS_APPOINTMENT_ENDTIME>
Całodzienne: <OTRS_APPOINTMENT_ALLDAY>
Powtarzanie: <OTRS_APPOINTMENT_RECURRING>
